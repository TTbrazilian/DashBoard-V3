...
def load_all_data():
    ...
    path_r  = buscar_arquivo("zEducação/Itaú de Minas_R.csv")
...
if df_f_raw is not None and df_r is not None:
    ...
    if st.session_state.setor == 'FUNDEB':
        st.markdown("<h1 style='text-align:left;'>📖 Itaú de Minas — FUNDEB</h1>",
                    unsafe_allow_html=True)
    ...
    # =========================================================================
        ...
        st.markdown("<h1 style='text-align:left;'>📖 Itaú de Minas — Recursos Próprios (25%)</h1>",
                    unsafe_allow_html=True)
