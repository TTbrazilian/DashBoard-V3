...
st.set_page_config(page_title="São João Batista do Glória - Gestão Educação", layout="wide")
...
def load_all_data():
    ...
    path_r  = buscar_arquivo("zEducação/São João Batista do Glória_R.csv")
    path_df = buscar_arquivo("zEducação/São João Batista do Glória_DF.csv")
    ...
    # ── RECEITAS — padrão Pratápolis (header real na linha 0 dos dados) ───────
    # Colunas: Orçado Receitas, Repasse, 2025, Atualização Quadrimestral, % Atualização
...
if df_f_raw is not None and df_r is not None:
    ...
    if st.session_state.setor == 'FUNDEB':
        st.markdown("<h1 style='text-align:left;'>📖 São João Batista do Glória — FUNDEB</h1>",
                    unsafe_allow_html=True)
        ...
        # 'Atualização Quadrimestral': limpar_valor UMA VEZ sobre string bruta
    ...
    # =========================================================================
        ...
        st.markdown("<h1 style='text-align:left;'>📖 São João Batista do Glória — Recursos Próprios (25%)</h1>",
                    unsafe_allow_html=True)
    ...
    # =========================================================================
        ...
        st.markdown("<h1 style='text-align:left;'>📖 São João Batista do Glória — Recursos Vinculados</h1>",
                    unsafe_allow_html=True)
    ...
    # =========================================================================
        ...
        st.markdown("<h1 style='text-align:left;'>📖 São João Batista do Glória — Folha de Pagamento</h1>",
                    unsafe_allow_html=True)
        st.markdown("---")
