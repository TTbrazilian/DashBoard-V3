...
st.markdown(
    """
    <style>
        /* CSS para esconder a navegação padrão de páginas se o arquivo estiver em um ambiente multipage */
...
if df_f_raw is not None and df_r is not None:
    # --- SIDEBAR (ALTERADA PARA EXIBIR APENAS SÃO TOMÁS) ---
    st.sidebar.title("📍 São Tomás de Aquino")
    st.sidebar.markdown("---")
