...
# CONFIGURAÇÕES TÉCNICAS E DE HOVER (PADRÃO SÃO TOMÁS)
...
def load_all_data():
    ...
    # Padronização da Coluna de Orçamento (Evita KeyError)
    if 'Orçamento Receitas' in df_r.columns:
        df_r = df_r.rename(columns={'Orçamento Receitas': 'Orçado Receitas'})
