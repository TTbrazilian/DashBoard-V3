...
st.set_page_config(page_title="Pratápolis - Gestão Educação", layout="wide")
...
def load_all_data():
    ...
    path_r  = buscar_arquivo("zEducação/Pratápolis_R.csv")
    path_df = buscar_arquivo("zEducação/Pratápolis_DF.csv")
...
if df_f_raw is not None and df_r is not None:
    ...
    if st.session_state.setor == 'FUNDEB':
        st.markdown("<h1 style='text-align:left;'>📖 Pratápolis — FUNDEB</h1>",
                    unsafe_allow_html=True)
    ...
    # =========================================================================
        ...
        st.markdown("<h1 style='text-align:left;'>📖 Pratápolis — Recursos Próprios (25%)</h1>",
                    unsafe_allow_html=True)
        ...
        # Pratápolis: descontos não apurados para este período
