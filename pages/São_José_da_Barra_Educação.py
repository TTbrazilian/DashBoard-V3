...
if df_f_raw is not None and df_r is not None:
    ...
    # =========================================================================
        ...
        # Rendimentos bancários por programa (Remunerações Bancárias com nome "Rendimentos XXXX")
        df_r_rem = df_r[df_r['Categoria'].str.strip() == 'Remunerações Bancárias'].copy()
        def _rend_prog(prog):
            """Retorna linha de rendimentos correspondente ao programa."""
        ...
        for prog in programas:
            ...
            df_rend_r  = _rend_prog(prog)   # linha de rendimentos deste programa
            ...
            # Total rendimentos acumulados deste programa
            ...
            if tipo_vinc == "Mensal":
                ...
                for m in meses_disponiveis:
                    ...
                    # Receita = repasse + rendimentos do mês
                    transf_m = df_prog_r[col_r].sum() if col_r else 0.0
                    ...
                    dados_m += [
                        {"Mês":m,"Tipo":"Receita","Valor":rec_m,
                         "Transf":transf_m,"Rend":rend_m},
                ...
                rec_acum   = soma(df_prog_r, meses_disponiveis) + rend_acum_prog
